...
public class UserController {
    ...
    public ModelAndView resultPage(@RequestParam String start_time,@RequestParam String end_time) throws ParseException {
        ModelAndView model1 = new ModelAndView();
        LocalDate start = LocalDate.parse(start_time);
        LocalDate end = LocalDate.parse(end_time);
        List<Car1> user = carService.getCarByCarId(start,end);
       /* Testing
       Car1 c = new Car1();
        c.setBrand("test");
        c.setType("test");
